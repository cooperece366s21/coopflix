...
public final class EpisodeBuilder {
  ...
  private EpisodeBuilder(Episode v) {
    this.id = v.id();
    this.title = v.title();
  ...
  private EpisodeBuilder(EpisodeBuilder v) {
    this.id = v.id;
    this.title = v.title;
    this.thumbnail = v.thumbnail;
    this.distributorId = v.distributorId;
  ...
  public EpisodeBuilder thumbnail(String thumbnail) {
    return thumbnail(Optional.ofNullable(thumbnail));
  }

  @SuppressWarnings("unchecked")
  public EpisodeBuilder thumbnail(Optional<? extends String> thumbnail) {
    if (thumbnail == null) {
  ...
  public EpisodeBuilder distributorId(String distributorId) {
    return distributorId(Optional.ofNullable(distributorId));
  }

  @SuppressWarnings("unchecked")
  public EpisodeBuilder distributorId(Optional<? extends String> distributorId) {
  ...
  public EpisodeBuilder genre(Content.Genre genre) {
    if (genre == null) {
  ...
  public EpisodeBuilder rating(Content.Rating rating) {
    return rating(Optional.ofNullable(rating));
  }

  @SuppressWarnings("unchecked")
  public EpisodeBuilder rating(Optional<? extends Content.Rating> rating) {
    if (rating == null) {
  ...
  public EpisodeBuilder fileId(String fileId) {
    return fileId(Optional.ofNullable(fileId));
  }

  @SuppressWarnings("unchecked")
  public EpisodeBuilder fileId(Optional<? extends String> fileId) {
    if (fileId == null) {
  ...
  public EpisodeBuilder length(Integer length) {
    return length(Optional.ofNullable(length));
  }

  @SuppressWarnings("unchecked")
  public EpisodeBuilder length(Optional<? extends Integer> length) {
    if (length == null) {
  ...
  @SuppressWarnings("unchecked")
  public EpisodeBuilder description(Optional<? extends String> description) {
    if (description == null) {
  ...
  public static EpisodeBuilder from(Episode v) {
    return new EpisodeBuilder(v);
  }

  public static EpisodeBuilder from(EpisodeBuilder v) {
    return new EpisodeBuilder(v);
  }

  private static final class Value implements Episode {
